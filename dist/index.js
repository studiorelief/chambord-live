...
(() => {
  ...
  function getTimeRemaining(endtime) {
    const total = parseDate(endtime) - Date.parse((/* @__PURE__ */ new Date()).toISOString());
  ...
  function appSwiper() {
    (0, import_jquery2.default)(".programmation_swiper").each(function(index) {
      const swiper = new Swiper((0, import_jquery2.default)(this).find(".swiper")[0], {
    ...
    (0, import_jquery2.default)(".actualites_swiper").each(function(index) {
      const swiper = new Swiper((0, import_jquery2.default)(this).find(".swiper")[0], {
        direction: "horizontal",
        followFinger: true,
        loop: true,
    ...
    (0, import_jquery2.default)(".actualites_swiper-inner").each(function(index) {
      const swiper = new Swiper((0, import_jquery2.default)(this).find(".swiper")[0], {
        direction: "horizontal",
        followFinger: true,
        loop: true,
